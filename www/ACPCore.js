...
var ACPMobileEdge = (function() {
    ...
    var PLUGIN_NAME = "ACPMobileEdge_Cordova";
    ...
    // public enums
    // ===========================================================================
    ACPMobileEdge.ACPMobilePrivacyStatusOptIn = 0;
    ACPMobileEdge.ACPMobilePrivacyStatusOptOut = 1;
    ACPMobileEdge.ACPMobilePrivacyStatusUnknown = 2;

    ACPMobileEdge.ACPMobileLogLevelError = 0;
    ACPMobileEdge.ACPMobileLogLevelWarning = 1;
    ACPMobileEdge.ACPMobileLogLevelDebug = 2;
    ACPMobileEdge.ACPMobileLogLevelVerbose = 3;

    // ===========================================================================
    // public APIs
    // ===========================================================================
    ACPMobileEdge.dispatchEvent = function(sdkEvent, success, fail) {
    ...
    ACPMobileEdge.dispatchEventWithResponseCallback = function(sdkEvent, success, fail) {
    ...
    ACPMobileEdge.dispatchResponseEvent = function(responseEvent, requestEvent, success, fail) {
    ...
    ACPMobileEdge.downloadRules = function(success, fail) {
    ...
    ACPMobileEdge.extensionVersion = function(success, fail) {
    ...
    ACPMobileEdge.getPrivacyStatus = function(success, fail) {
    ...
    ACPMobileEdge.getSdkIdentities = function(success, fail) {
    ...
    ACPMobileEdge.setAdvertisingIdentifier = function(identifier, success, fail) {
    ...
    ACPMobileEdge.setLogLevel = function(logLevel, success, fail) {
    ...
    ACPMobileEdge.setPrivacyStatus = function(privacyStatus, success, fail) {
    ...
    ACPMobileEdge.trackAction = function(action, contextData, success, fail) {
    ...
    ACPMobileEdge.trackState = function(state, contextData, success, fail) {
    ...
    ACPMobileEdge.updateConfiguration = function(config, success, fail) {
